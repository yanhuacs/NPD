...
{ 
    ...
    private Stmt stmt;
    private ParameterizedMethod container;
    private NumberedString subSig;
    Kind kind;

    public VirtualInvokeSite( Stmt stmt, ParameterizedMethod container,
    ...
    public ParameterizedMethod container() { return container; }
